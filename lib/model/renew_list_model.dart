...
RenewListModel renewListModelFromJson(String str) => RenewListModel.fromJson(json.decode(str));

String renewListModelToJson(RenewListModel data) => json.encode(data.toJson());

class RenewListModel {
  RenewListModel({
    this.data,
    this.links,
    required this.meta,
  ...
  factory RenewListModel.fromJson(Map<String, dynamic> json) => RenewListModel(
    data: List<RenewListData>.from(json["data"].map((x) => RenewListData.fromJson(x))),
...
class RenewListData {
  ...
  factory RenewListData.fromJson(Map<String, dynamic> json) => RenewListData(
    id: json["id"],
    code: json["code"],
    date: json["date"],
...
class RenewListLoadingState {
  LoadingType? loadingType;
  String? error;
  String? completed;

  RenewListLoadingState({required this.loadingType, this.error, this.completed});
}
